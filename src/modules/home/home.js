...
class Home extends React.Component {
  ...
  componentDidMount = () => {
    ...
    //   // axios.post('/homes/swipe').then((data)=>{
    //     axios.post('http://127.0.0.1:18080/ad').then((data)=>{
    ...
    let info = new Promise((resolve, reject) => {
      ...
      //   resolve(data.data.list);
      // });
      axios.get('http://127.0.0.1:18080/mock/indexInfo').then((data)=>{
        resolve(data.data.list);
      })
    })
    let faq = new Promise((resolve, reject) => {
      ...
      //   resolve(data.data.list);
      // });
      axios.get('http://127.0.0.1:18080/mock/indexFaq').then((data)=>{
        resolve(data.data.list);
      })
    })
    let house = new Promise((resolve, reject) => {
      ...
      //   resolve(data.data.list);
      // });
      axios.get('http://127.0.0.1:18080/mock/indexHouse').then((data)=>{
        resolve(data.data.list);
      })
    })
